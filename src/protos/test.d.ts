...
export class TestEvent implements ITestEvent {
     ...
     * @param [properties] Properties to set
     */
    constructor(properties?: ITestEvent);
     ...
     * @param [properties] Properties to set
     * @returns TestEvent instance
     */
    public static create(properties?: ITestEvent): TestEvent;

    /**
     * Encodes the specified TestEvent message. Does not implicitly {@link TestEvent.verify|verify} messages.
     * @param message TestEvent message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: ITestEvent, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: ITestEvent, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): TestEvent;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): TestEvent;
     ...
     * @returns TestEvent
     */
    public static fromObject(object: { [k: string]: any }): TestEvent;

    /**
     * Creates a plain object from a TestEvent message. Also converts values to other types if specified.
     * @param message TestEvent
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: TestEvent, options?: $protobuf.IConversionOptions): { [k: string]: any };
